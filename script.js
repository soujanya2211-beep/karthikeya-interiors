...
(function () {
  ...
  const I18N = {
    en: {
      nav_services: "Services", nav_why: "Why Us", nav_portfolio: "Portfolio", nav_about: "About", nav_faq: "FAQ", nav_contact: "Contact", nav_quote: "Get Quote",
      ...
      footer_map: "Open in Google Maps →", footer_hours: "Service Area", footer_area: "All over Hyderabad — Medipally, Uppal, LB Nagar, Nagole, Boduppal, Secunderabad & more",
      footer_hours_v: "Mon – Sun, 9 AM – 8 PM", footer_rights: "All rights reserved.", footer_built: "Affordable luxury interiors • Hyderabad",
      faq_eyebrow: "FAQ", faq_title: "Interior Design in Hyderabad — Common Questions",
      faq_q1: "How much does interior design cost for a 2BHK or 3BHK flat in Hyderabad?",
      faq_a1: "The interior design cost in Hyderabad depends on the size of your home (1BHK, 2BHK, 3BHK or villa), the materials and the finish level — budget, mid-range or luxury. Karthikieya Interiors offers affordable, transparent packages for every budget. Share your home details on WhatsApp and we'll send a free, no-obligation quote.",
      faq_q2: "Do you provide complete turnkey home interiors in Hyderabad?",
      faq_a2: "Yes. We handle end-to-end turnkey interior projects — modular kitchens, wardrobes, TV units, false ceiling, wall painting, electrical work and deep cleaning — so your home or office is delivered move-in ready.",
      faq_q3: "Which areas in Hyderabad do you serve?",
      faq_a3: "We provide interior design and modular kitchen services all over Hyderabad, including Medipally, Uppal, LB Nagar, Nagole, Boduppal, Secunderabad and surrounding areas. Home visits are available.",
      faq_q4: "How do I get started or book a consultation?",
      faq_a4: "Simply tap the WhatsApp button or fill the Get a Free Quote form on this page. We'll understand your requirements, arrange a home visit if needed, and share a design plan and estimate.",
    ...
    te: {
      nav_services: "సేవలు", nav_why: "మమ్మల్ని ఎందుకు", nav_portfolio: "పోర్ట్‌ఫోలియో", nav_about: "మా గురించి", nav_faq: "ప్రశ్నలు", nav_contact: "సంప్రదించండి", nav_quote: "కోట్ పొందండి",
      ...
      footer_map: "గూగుల్ మ్యాప్స్‌లో తెరవండి →", footer_hours: "సేవా ప్రాంతం", footer_area: "హైదరాబాద్ అంతటా — మేడిపల్లి, ఉప్పల్, ఎల్‌బీ నగర్, నాగోల్, బోడుప్పల్, సికింద్రాబాద్ & మరిన్ని",
      ...
      faq_eyebrow: "ప్రశ్నలు", faq_title: "హైదరాబాద్‌లో ఇంటీరియర్ డిజైన్ — సాధారణ ప్రశ్నలు",
      faq_q1: "హైదరాబాద్‌లో 2BHK లేదా 3BHK ఫ్లాట్‌కు ఇంటీరియర్ డిజైన్ ఖర్చు ఎంత?",
      faq_a1: "హైదరాబాద్‌లో ఇంటీరియర్ డిజైన్ ఖర్చు మీ ఇంటి పరిమాణం (1BHK, 2BHK, 3BHK లేదా విల్లా), మెటీరియల్స్ మరియు ఫినిష్ స్థాయి — బడ్జెట్, మిడ్-రేంజ్ లేదా లగ్జరీ పై ఆధారపడి ఉంటుంది. కార్తికేయ ఇంటీరియర్స్ ప్రతి బడ్జెట్‌కు అందుబాటులో ఉండే, పారదర్శక ప్యాకేజీలను అందిస్తుంది. మీ ఇంటి వివరాలను వాట్సాప్‌లో పంచుకోండి, మేము ఉచిత కోట్ పంపుతాం.",
      faq_q2: "మీరు హైదరాబాద్‌లో పూర్తి టర్న్‌కీ హోమ్ ఇంటీరియర్లను అందిస్తారా?",
      faq_a2: "అవును. మేము మొదటి నుండి చివరి వరకు టర్న్‌కీ ఇంటీరియర్ ప్రాజెక్టులను — మాడ్యులర్ కిచెన్‌లు, వార్డ్‌రోబ్‌లు, టీవీ యూనిట్లు, ఫాల్స్ సీలింగ్, వాల్ పెయింటింగ్, ఎలక్ట్రికల్ పని మరియు డీప్ క్లీనింగ్ — నిర్వహిస్తాం, మీ ఇల్లు లేదా ఆఫీస్ నివాసానికి సిద్ధంగా అందజేస్తాం.",
      faq_q3: "హైదరాబాద్‌లో మీరు ఏ ప్రాంతాలకు సేవలు అందిస్తారు?",
      faq_a3: "మేము హైదరాబాద్ అంతటా — మేడిపల్లి, ఉప్పల్, ఎల్‌బీ నగర్, నాగోల్, బోడుప్పల్, సికింద్రాబాద్ మరియు చుట్టుపక్కల ప్రాంతాలలో ఇంటీరియర్ డిజైన్ మరియు మాడ్యులర్ కిచెన్ సేవలను అందిస్తాం. ఇంటి సందర్శన అందుబాటులో ఉంది.",
      faq_q4: "నేను ఎలా ప్రారంభించాలి లేదా సంప్రదింపు బుక్ చేయాలి?",
      faq_a4: "ఈ పేజీలోని వాట్సాప్ బటన్‌ను నొక్కండి లేదా ఉచిత కోట్ ఫారమ్‌ను నింపండి. మేము మీ అవసరాలను అర్థం చేసుకుంటాం, అవసరమైతే ఇంటి సందర్శన ఏర్పాటు చేస్తాం, మరియు డిజైన్ ప్లాన్ మరియు అంచనాను పంపుతాం.",
    ...
    hi: {
      nav_services: "सेवाएं", nav_why: "क्यों चुनें", nav_portfolio: "पोर्टफोलियो", nav_about: "हमारे बारे में", nav_faq: "सवाल", nav_contact: "संपर्क", nav_quote: "कोट लें",
      ...
      footer_map: "गूगल मैप्स में खोलें →", footer_hours: "सेवा क्षेत्र", footer_area: "पूरे हैदराबाद में — मेडिपल्ली, उप्पल, एलबी नगर, नागोल, बोडुप्पल, सिकंदराबाद और अधिक",
      footer_hours_v: "सोम – रवि, सुबह 9 – रात 8", footer_rights: "सर्वाधिकार सुरक्षित।", footer_built: "किफायती लक्जरी इंटीरियर्स • हैदराबाद",
      faq_eyebrow: "सवाल", faq_title: "हैदराबाद में इंटीरियर डिज़ाइन — आम सवाल",
      faq_q1: "हैदराबाद में 2BHK या 3BHK फ्लैट के इंटीरियर डिज़ाइन की लागत कितनी है?",
      faq_a1: "हैदराबाद में इंटीरियर डिज़ाइन की लागत आपके घर के आकार (1BHK, 2BHK, 3BHK या विला), सामग्री और फिनिश स्तर — बजट, मिड-रेंज या लक्जरी पर निर्भर करती है। कार्तिकेया इंटीरियर्स हर बजट के लिए किफायती, पारदर्शी पैकेज देता है। अपने घर का विवरण व्हाट्सएप पर साझा करें, हम मुफ्त कोट भेजेंगे।",
      faq_q2: "क्या आप हैदराबाद में संपूर्ण टर्नकी होम इंटीरियर प्रदान करते हैं?",
      faq_a2: "हाँ। हम शुरू से अंत तक टर्नकी इंटीरियर प्रोजेक्ट संभालते हैं — मॉड्यूलर किचन, वार्डरोब, टीवी यूनिट, फॉल्स सीलिंग, वॉल पेंटिंग, इलेक्ट्रिकल कार्य और डीप क्लीनिंग — ताकि आपका घर या ऑफिस मूव-इन रेडी मिले।",
      faq_q3: "हैदराबाद में आप किन क्षेत्रों में सेवा देते हैं?",
      faq_a3: "हम पूरे हैदराबाद में — मेडिपल्ली, उप्पल, एलबी नगर, नागोल, बोडुप्पल, सिकंदराबाद और आसपास के क्षेत्रों में इंटीरियर डिज़ाइन और मॉड्यूलर किचन सेवाएं देते हैं। घर पर विज़िट उपलब्ध है।",
      faq_q4: "मैं कैसे शुरू करूं या परामर्श बुक करूं?",
      faq_a4: "बस इस पेज पर व्हाट्सएप बटन दबाएं या मुफ्त कोट फॉर्म भरें। हम आपकी ज़रूरतें समझेंगे, ज़रूरत होने पर घर पर विज़िट की व्यवस्था करेंगे, और डिज़ाइन प्लान व अनुमान भेजेंगे।",
